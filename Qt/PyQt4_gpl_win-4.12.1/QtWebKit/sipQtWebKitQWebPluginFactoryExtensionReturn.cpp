...
#include <qwebpluginfactory.h>
#line 31 "/home/rodrigo/Documents/Ajedrez/Qt/PyQt4_gpl_win-4.12.1/QtWebKit/sipQtWebKitQWebPluginFactoryExtensionReturn.cpp"
...
extern "C" {static void assign_QWebPluginFactory_ExtensionReturn(void *, SIP_SSIZE_T, void *);}
static void assign_QWebPluginFactory_ExtensionReturn(void *sipDst, SIP_SSIZE_T sipDstIdx, void *sipSrc)
{
    reinterpret_cast< ::QWebPluginFactory::ExtensionReturn *>(sipDst)[sipDstIdx] = *reinterpret_cast< ::QWebPluginFactory::ExtensionReturn *>(sipSrc);
}
