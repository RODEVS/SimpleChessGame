...
_pkg_config = {
    ...
    'pyqt_config_args':  '',
    'pyqt_mod_dir':      '/usr/lib/python3.6/site-packages/PyQt4',
    'pyqt_modules':      'QtCore QtGui QtMultimedia QtNetwork QtDBus QtOpenGL QtSql QtSvg QtTest QtWebKit QtXml QtXmlPatterns',
    'pyqt_sip_dir':      '/usr/share/sip/PyQt4',
    'pyqt_sip_flags':    '-x VendorID -t WS_X11 -x PyQt_NoPrintRangeBug -t Qt_5_0_0 -g',
    'pyqt_version':      0x040c01,
    'pyqt_version_str':  '4.12.1',
    'qt_archdata_dir':   '/usr/lib/qt',
    'qt_data_dir':       '/usr/share/qt',
    'qt_dir':            '/usr',
    'qt_edition':        'Desktop',
    'qt_framework':      0,
...
_default_macros = {
    ...
    'CFLAGS_MT_DLL':            '',
    'CFLAGS_MT_DLLDBG':         '',
    'CFLAGS_RELEASE':           '-O2 -march=x86-64 -mtune=generic -O2 -pipe -fstack-protector-strong -fno-plt',
    'CFLAGS_RTTI_OFF':          '',
    'CFLAGS_RTTI_ON':           '',
    'CFLAGS_SHLIB':             '-fPIC',
    'CFLAGS_STL_OFF':           '',
    ...
    'CXXFLAGS_MT_DLL':          '',
    'CXXFLAGS_MT_DLLDBG':       '',
    'CXXFLAGS_RELEASE':         '-O2 -march=x86-64 -mtune=generic -O2 -pipe -fstack-protector-strong -fno-plt',
    'CXXFLAGS_RTTI_OFF':        '',
    'CXXFLAGS_RTTI_ON':         '',
    'CXXFLAGS_SHLIB':           '-fPIC',
    'CXXFLAGS_STL_OFF':         '',
    ...
    'LFLAGS_RELEASE':           ' -Wl,-O1 -Wl,-O1,--sort-common,--as-needed,-z,relro,-z,now',
