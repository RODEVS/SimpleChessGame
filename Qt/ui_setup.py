...
class Ui_ventanaPrincipal(object):
    def setupUi(self, ventanaPrincipal):
        ...
        ventanaPrincipal.resize(259, 176)
    ...
    def retranslateUi(self, ventanaPrincipal):
        ...
        self.ayudaCheck.setText(_translate("ventanaPrincipal", "Marcar Escaques", None))
        ...
        self.label_3.setText(_translate("ventanaPrincipal", "Desarrollado por Rodrigo Alexis", None))
        self.label_4.setText(_translate("ventanaPrincipal", "roxtarmx@gmail.com", None))
